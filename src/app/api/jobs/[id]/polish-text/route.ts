/*
 * POST /api/jobs/[id]/polish-text
 *
 * Staff-only: fixes spelling, grammar, and punctuation in free text (e.g. speech
 * transcripts). Does not add facts or change meaning — backend AI, invisible to clients.
 */
