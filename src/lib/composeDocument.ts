...
function composeWdm(job: Job): ComposeDocumentResult {
  ...
  const prices = disposalPriceLines(loads, capture.cost_per_m3, capture.prepaid_m3)
  ...
  const c: WasteDisposalManifestContent = {
    ...
    totals: {
      ...
      trailer_ute_fees: prices.trailers_utes_ex,
      prepaid_value: prices.prepaid_ex,
      price_total: prices.total_inc,
      skip_fees_ex: prices.skips_ex,
      dump_fees_ex: prices.dump_fees_ex,
...
function composeStatement(job: Job, documents: Document[]): ComposeDocumentResult {
  ...
  return {
    content: {
      ...
      invoice1_revised_ex: figures.invoice1_revised_ex,
      invoice1_revised_inc: figures.invoice1_revised_inc,
      remeasure_ex: figures.remeasure_ex,
      remeasure_inc: figures.remeasure_inc,
      invoice2_owing_ex: figures.invoice2_owing_ex,
