...
- When staff capture is absent or sparse, synthesise from the HITL lists:
    * hazards_overview ← PRESENTING HAZARDS (group by category, short prose).
    * risks_overview ← PRESENTING RISKS (tie each risk back to a hazard where source_hazard_ids shows the link).
