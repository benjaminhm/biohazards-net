...
Use realistic Australian market rates for biohazard work ($120–$250/hr depending on contamination level). Base labour on contamination level (${a.contamination_level}/5) and estimated hours (${a.estimated_hours}hrs). Include line items for: labour per area, PPE, waste disposal, callout fee, and specialist requirements. Reference the specific areas, photo notes, and conditions found — do not be generic. Ensure subtotal + GST (10%) = total. Return ONLY the JSON object.`
}
